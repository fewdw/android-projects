package com.champlain.contactroom.model;
...
import com.champlain.contactroom.data.ContactRepository;
...
public class ContactViewModel extends AndroidViewModel {
    ...
    /*
    public LiveData<Contact>get(int id){return repository.get(id);}
    public static void update(Contact contact){repository.update();}
    public static void delete(Contact contact){repository.delete();}
    */
